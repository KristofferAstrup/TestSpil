...
/*
    ...
    private IState.GameStates.IState.GameStates gameState;
    ...
    public void update(IState.GameStates.IState.GameStates gameState) {
    ...
    {
        AffineTransform trans = new AffineTransform();
        for(Worlds.WorldObjects.DynamicObjects.DynamicObjects obj : gameState.getWorld().getDynamicObjects())
        {
            trans = new AffineTransform();
    ...
    private void drawGUI(Vectors.DynamicVector target,Graphics2D g2d)
    {
        ...
        //g2d.drawString("fps = " + Controllers.Main.globalFps,150,15);
    }
